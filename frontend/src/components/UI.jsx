    ...
    return (
        <>
            <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col pointer-events-none">
                <div className="self-start backdrop-blur-md bg-opacity-50 p-4 rounded-lg flex justify-center items-center">
                    {/* Improved logo */}
                    <img
                        src="gtc.png"
                        alt="Logo"
                        className="w-32 hidden h-auto hover:scale-105 transform transition-all duration-300 ease-in-out rounded-lg shadow-lg"
                    />
                </div>
                <div className="w-full flex flex-col items-end justify-center gap-4">
                    <button
                        onClick={() => setCameraZoomed(!cameraZoomed)}
                        className="pointer-events-auto bg-purple-500 hover:bg-purple-600 text-white p-4 rounded-md"
                    >
                        {cameraZoomed ? (
                            <svg
                ...
                <img src="ai-ml-club.png" className="fixed bottom-0 left-0 w-60 h-60" />
...
<>
    <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col pointer-events-none">
        <div className="self-start backdrop-blur-md bg-opacity-50 p-4 rounded-lg flex justify-center items-center">
            {/* Improved logo */}
            <img 
                src="tech-council.png" 
                alt="Logo"
                className="w-32 h-auto hover:scale-105 transform transition-all duration-300 ease-in-out rounded-lg shadow-lg" 
            />
        </div>
        <div className="w-full flex flex-col items-end justify-center gap-4">
            <button
        ...
        <img src="club.png" className="fixed bottom-0 left-0 w-60 h-60" />
        <div className="flex items-center gap-2 pointer-events-auto max-w-screen-sm w-full mx-auto">
            <input
                className="w-full placeholder:text-gray-800 placeholder:italic p-4 rounded-md bg-opacity-50 bg-white backdrop-blur-md"
                placeholder="Type a message..."
            ...
            {audioState === "idle" ?
                ...
                >
                    ...
                    <button
                        ...
                        onClick={sendMessage}
                        className={`bg-purple-500 hover:bg-purple-600 text-white p-4 px-10 font-semibold uppercase rounded-md ${loading || message ? "cursor-not-allowed opacity-30" : ""
                            }`}
                    >
                        Send
                    </button>
